...
export const mealPlanData = {
  calories: [{
    calories: 2200,
    id: calorieNeed2200Id
  },
  {
    calories: 1900,
    id: calorieNeed1900Id
  }, {
    calories: 1700,
    id: calorieNeed1700Id
  }, {
    calories: 2000,
    id: calorieNeed2000Id
  },
  {
    calories: 2300,
    id: calorieNeed2300Id
  },
  {
    calories: 1400,
    id: calorieNeed1400Id
  },
  {
    calories: 1600,
    id: calorieNeed1600Id
  },
  {
    calories: 1300,
    id: calorieNeed1300Id
  },
  {
    calories: 1500,
    id: calorieNeed1500Id
  },
  {
    calories: 1800,
    id: calorieNeed1800Id
  },
  {
    calories: 2100,
    id: calorieNeed2100Id
  },
  {
    calories: 1200,
    id: calorieNeed1200Id
  }],


  mealPlan: [{
    day: 'Monday',
    breakfast: `4 slices of white or wheat bread +
    fried eggs (3 eggs, remove 1 yolk
    + 1 teaspoon of oil + 1 cup of
    mixed veggies) + 1 cup of diced
    watermelon`,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `1 serving of jollof rice (see recipe) + 2
    pieces of chicken with skin`,
    lunchCalories: 750,
    dinner: `Pepper soup + 1½ cups of diced
    potatoes + 2 pieces of chicken thigh
    with skin (see recipe) + 1 piece of
    chicken drumstick with skin`,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  }, {
    day: 'Tuesday',
    breakfast: `2 cups of cornflakes + 1 milk + 1
    boiled egg + 1 piece of chicken
    with skin + 1 small orange`,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `1 cup of cooked eba (see size in
      index) + 1 serving of efo-riro or okra
      (see recipe) + 1 piece of lean beef,
      145g cooked (or 1 piece of chicken
      thigh with skin + 1 chicken
      drumstick with skin)`,
    lunchCalories: 750,
    dinner: `Fruit bowl (2 small apple + 2 cups of
      diced watermelon + 2 medium
      bananas) + 2 pieces of fish
      `,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  },
  {
    day: 'Wednesday',
    breakfast: `2½ cups of potatoes (boiled,
      grilled or air-fried) + 1 serving of
      fish sauce (see recipe) + 1 cup
      diced pineapple`,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `1 serving of beans pottage (see
      recipe) + 1 medium plantain (180g
      without peel) + 1 piece of fish`,
    lunchCalories: 750,
    dinner: `⅔ cup of garri (to soak) + 20 peanuts
    + ½ a small cucumber + 1 piece of
    chicken with skin (or 1 piece of fish)`,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  }, {
    day: 'Thursday',
    breakfast: `1 large plantain (230g without
      peel) + fried eggs (2 eggs + 1
      teaspoon of oil + 1 cup of mixed
      veggies) + 1 large apple`,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `1¾ cups of cooked white rice (or
      spaghetti) + 1 serving of efo-riro
      (see recipe) + 2 pieces of chicken
      with skin`,
    lunchCalories: 750,
    dinner: `Parfait (1 cup Greek yoghurt + 1
      small apple + 1 medium banana + 5
      tablespoons granola + 12 cashew
      nuts
      `,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  ...
  {
    day: 'Friday',
    breakfast: `⅔ cup of oat (measured raw
      before cooking) + 1 milk + 1
      medium banana (67g without
      peel) + 14 peanuts + 1 piece of
      chicken with skin`,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `1½ small pack (70g pack) of
    noodles + 1 teaspoon of oil + 1 cup
    of mixed veggies + 1 piece of
    skinless chicken + 1 boiled egg`,
    lunchCalories: 750,
    dinner: `Salad - 2 cup coleslaw + 2 lettuce
    leaves chopped + ½ cup cucumber +
    1 piece of skinless chicken shredded
    + 2 boiled eggs + ⅓ cup sweetcorn +
    ½ cup grapes + 3 dressings`,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  },
  {
    day: 'Saturday',
    breakfast: `Sandwich (3 slices of white or
      wheat bread + ½ cup of coleslaw + 1 boiled egg + 1 skinless piece
      of chicken, shredded + 2
      dressings) + 1 cup diced pawpaw
      `,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `1 serving of yam pottage (see
      recipe) + 2 pieces of chicken with skin`,
    lunchCalories: 750,
    dinner: `1 large plantain (230g without peel)
    + 1 serving of spinach stir-fy (see recipe) + 1 piece of fish + 1 boiled egg`,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  }, {
    day: 'Sunday',
    breakfast: `Fruit bowl (2 small apples + 1 cup
      of diced watermelon + ½ cup of
      grapes + top with ½ cup of Greek
      yoghurt ) + 2 pieces of fish`,
    breakfastCalories: 600,
    snackCalories: 250,
    lunch: `Cheat Meal`,
    lunchCalories: 750,
    dinner: `1 wrap of moi-moi (see recipe) + 1
    serving of efo-riro (see recipe) + 1
    boiled egg`,
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2200Id
  },
...

  {
    ...
    lunch: '1 serving of jollof rice (see recipe) + 1 piece of chicken with skin',
    lunchCalories: 600,
    dinner: 'Pepper soup + 1½ cups of diced potatoes + 2 pieces of chicken thigh with skin (see recipe) + 1 piece of chicken drumstick with skin',
    dinnerCalories: 600,
  ...
  },
  {
    ...
    snack: 'Cheat Meal',
    snackCalories: 200,
    lunch: '1 wrap of moi-moi (see recipe) + 1 serving of efo-riro (see recipe) + 1 boiled egg',
    lunchCalories: 600,
    dinner: '1 large plantain (230g without peel) + 1 serving of spinach stir-fry (see recipe) + 1 piece of fish + 1 boiled egg',
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2000Id,
...

  {
    ...
    lunchCalories: 750,
    dinner: 'Pepper soup + 2 cups of diced potatoes + 2 pieces of chicken thigh with skin (see recipe) + 1 piece of chicken drumstick with skin',
    dinnerCalories: 650,
  ...
  },
  {
    ...
    lunchCalories: 450,
    dinner: 'Pepper soup + 1 cup of diced potatoes + 1 piece of chicken thigh with skin + 1 piece of chicken drumstick with skin (see recipe)',
    dinnerCalories: 400,
  ...
  },
  {
    ...
    lunch: '1 serving of yam pottage (see recipe) + 1 piece of chicken with skin',
    lunchCalories: 550,
    dinner: '1 medium plantain (180g without peel) + 1 serving spinach stir-fy (see recipe) + 3 chicken gizzards',
    dinnerCalories: 400,
    calorieNeedId: calorieNeed1500Id
  ...
  },
  {
    ...
    lunch: '1 serving of yam pottage (see recipe) + 1 piece of chicken with skin',
    lunchCalories: 600,
    dinner: '1 medium plantain (180g without peel) + 1 serving spinach stir-fy (see recipe) + 5 chicken gizzards',
    dinnerCalories: 500,
    calorieNeedId: calorieNeed1800Id
  },
  {
  ...
  },
  {
    ...
    lunch: '1 serving of yam pottage (see recipe) + 1 piece of chicken with skin',
    lunchCalories: 700,
    dinner: '1 large plantain (230g without peel) + 1 serving spinach stir-fy (see recipe) + 1 piece of fish + 1 boiled egg',
    dinnerCalories: 600,
    calorieNeedId: calorieNeed2100Id
